...
from gs16_dataset.dataset import ImageNet16
...
parser.add_argument('--data_dir', default = '/media/data_cifs/projects/prj_model_vs_human/model-vs-human/model-vs-human/datasets/colour/dnn/session-1', 
...
parser.add_argument('--prompt_path', type=str, default = 'imagenet16_prompts', help='Path to csv file with prompts to use')
...
def main():
    ...
    target_dataset = ImageNet16(data_folder = args.data_dir, transform = transform)
    # sampler = DistributedSampler(target_dataset, num_replicas=world_size, rank=local_rank, drop_last=True)
    ...
    idxs_to_eval = idxs[local_rank::world_size]
